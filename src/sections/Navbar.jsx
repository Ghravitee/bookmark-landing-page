...
const Navbar = () => {
  ...
  return (
    <header>
      ...
      {!isOpen && (
        <div className="flex lg:hidden gap-3 items-center justify-between px-6 py-6 fixed top-0 z-50 w-full bg-white">
          <img src={logo} alt="" width={120} height={120} />
      ...
      {isOpen && (
        <motion.nav
          ...
          className="lg:hidden fixed top-0 left-0 right-0 mx-auto z-50 h-screen bg-Very-Dark-Blue flex flex-col py-4"
        >
          <div className="">
          ...
          <div className="flex items-center justify-center gap-8 mt-auto">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
              <path
                className="hover:fill-Soft-Red fill-white cursor-pointer"
                fillRule="evenodd"
