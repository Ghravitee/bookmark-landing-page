const Footer = () => {
  return (
    <footer className="bg-Very-Dark-Blue py-10 px-6">
      <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-center justify-between">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <ul className="flex flex-col lg:flex-row items-center gap-8 text-white text-[0.8rem] tracking-widest">
            <li>
              <a
                href=""
                className="uppercase text-[1.1rem] lg:text-[0.8rem] tracking-widest hover:text-Soft-Red cursor-pointer"
              >
                features
              </a>
            </li>
